...
public class KMarkdown {
  ...
  public static class H1 extends KMarkdown {

    private H1(String value) {
      this.value = String.format("# %s", value);
    }

    public static H1 create(String value) {
      return new H1(value);
    }
  }

  public static class H2 extends KMarkdown {

    private H2(String value) {
      this.value = String.format("## %s", value);
    }

    public static H2 create(String value) {
      return new H2(value);
    }
  }

  public static class H3 extends KMarkdown {

    private H3(String value) {
      this.value = String.format("### %s", value);
    }

    public static H3 create(String value) {
      return new H3(value);
    }
  }

  public static class H4 extends KMarkdown {

    private H4(String value) {
      this.value = String.format("#### %s", value);
    }

    public static H4 create(String value) {
      return new H4(value);
    }
  }

  public static class H5 extends KMarkdown {

    private H5(String value) {
      this.value = String.format("##### %s", value);
    }

    public static H5 create(String value) {
      return new H5(value);
    }
  }

  public static class H6 extends KMarkdown {

    private H6(String value) {
      this.value = String.format("###### %s", value);
    }

    public static H6 create(String value) {
      return new H6(value);
    }
  }
